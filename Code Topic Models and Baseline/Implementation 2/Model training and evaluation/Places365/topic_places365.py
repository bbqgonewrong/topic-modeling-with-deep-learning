...
v_batch_size = 50
num_epochs =100
model_name = 'topic_weight_k4_places_20_imp2_1'
...
train_dir = '/data/s4133366/places365_20/train'
...
dense_full = tf.keras.layers.Dense(1000,name = 'dense_full',activation = 'relu')(conc_1)
...
topic = tf.keras.layers.Dense(512,activation='relu',name = 'second_dense')(topic)
topic = tf.keras.layers.Dropout(0.2)(topic)
final = tf.keras.layers.Dense(20,activation='softmax',name = 'places')(topic)
...
cent_model.load_weights('/data/s4133366/saved_models/topic_weight_k4_places_20_imp2/topic_weight_k4_places_20_imp2_weights/topic_weight_k4_places_20_imp2_weights.h5')
...
history = cent_model.fit(train_ds,epochs=num_epochs,callbacks=callbacks,verbose=1,workers=8,use_multiprocessing = False,steps_per_epoch = steps,shuffle = False)
