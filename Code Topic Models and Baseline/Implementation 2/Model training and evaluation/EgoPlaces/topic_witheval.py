...
ev_batch_size = 128
num_epochs =50
model_name = 'topic_weight_k4_imp_9_nn_2'
...
topic = tf.keras.layers.Dense(256,activation='relu',name = 'second_dense')(topic)
topic = tf.keras.layers.Dropout(0.2)(topic)
final = tf.keras.layers.Dense(23,activation='softmax',name = 'places')(topic)
...
cent_model.load_weights('/data/s4133366/saved_models/topic_weight_k4_imp_9_nn_1/topic_weight_k4_imp_9_nn_1_weights/topic_weight_k4_imp_9_nn_1_weights.h5')
