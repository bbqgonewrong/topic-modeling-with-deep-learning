...
v_batch_size = 50
num_epochs =100
model_name = 'topic_weight_k4_places_20_imp1_1'
...
final = tf.keras.layers.Dense(20,activation='softmax')(topic)
...
cent_model.load_weights('/data/s4133366/saved_models/topic_weight_k4_places_20_imp1/topic_weight_k4_places_20_imp1_weights/topic_weight_k4_places_20_imp1_weights.h5')
